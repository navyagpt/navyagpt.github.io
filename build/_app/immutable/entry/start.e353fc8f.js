import { o as me, t as we } from "../chunks/index.116c98fe.js";
import {
  S as Ge,
  a as Je,
  I as M,
  ...
  P as Me,
  h as Ze,
} from "../chunks/singletons.dd0a5f40.js";
function Qe(t, r) {
  return t === "/" || r === "ignore"
    ? t
    : r === "never"
...
window.fetch = (t, r) => (
  (t instanceof Request
    ? t.method
    : (r == null ? void 0 : r.method) || "GET") !== "GET" && ae.delete(Se(t)),
  Ke(t, r)
);
const ae = new Map();
function ct(t) {
...
function lt(t, r) {
  ...
  if (i != null && i.textContent) {
    let { body: h, ...u } = JSON.parse(i.textContent);
    const E = i.getAttribute("data-ttl");
    return (
      E && ae.set(f, { body: h, init: u, ttl: 1e3 * Number(E) }),
      i.getAttribute("data-b64") !== null && (h = ct(h)),
      Promise.resolve(new Response(h, u))
    );
  }
...
function gt(t, r, f) {
  ...
  for (let l = 0; l < r.length; l += 1) {
    ...
    if (!g.matcher || f[g.matcher](m)) {
      ...
      const d = r[l + 1],
        N = h[l + 1];
      d && !d.rest && d.optional && N && g.chained && (E = 0),
        !d && !N && Object.keys(i).length === u.length && (E = 0);
      continue;
    }
...
function mt({ nodes: t, server_loads: r, dictionary: f, matchers: i }) {
  const h = new Set(r);
  return Object.entries(f).map(([l, [g, m, d]]) => {
    const { pattern: N, params: T } = dt(l),
      R = {
        id: l,
        exec: (D) => {
          const U = N.exec(D);
    ...
    return (
      (R.errors.length = R.layouts.length =
        Math.max(R.errors.length, R.layouts.length)),
      R
    );
  });
  function u(l) {
...
async function At(t, r) {
  var f;
  for (const i in t)
    if (typeof ((f = t[i]) == null ? void 0 : f.then) == "function")
      return Object.fromEntries(
        await Promise.all(Object.entries(t).map(async ([h, u]) => [h, await u]))
      );
  return t;
}
class ne {
...
function Ot(t, r) {
  ...
  let d = { branch: [], error: null, url: null },
    ...
    z = !1,
    V,
    x = (je = history.state) == null ? void 0 : je[M];
  x ||
    ((x = Date.now()),
    history.replaceState({ ...history.state, [M]: x }, "", location.href));
  const fe = J[x];
  ...
  async function ke() {
    ...
    if (n === W && o) {
      if (o.type === "redirect")
        return re(new URL(o.location, e).href, {}, 1, n);
      o.props.page !== void 0 && (H = o.props.page), V.$set(o.props);
    }
  }
  function Re(e) {
    l.some((s) => (s == null ? void 0 : s.snapshot)) &&
      (ee[e] = l.map((s) => {
        var n;
        return (n = s == null ? void 0 : s.snapshot) == null
          ? void 0
          : n.capture();
      }));
  }
  ...
  async function re(
    ...
    return (
      typeof e == "string" && (e = new URL(e, Ce(document))),
      ce({
        url: e,
        scroll: s ? te() : null,
        keepfocus: o,
        redirect_count: p,
        details: { state: a, replaceState: n },
        nav_token: _,
        accepted: () => {
          c && (z = !0);
        },
  ...
  async function Le(e) {
    return (
      (g = {
        id: e.id,
        promise: he(e).then(
          (s) => (s.type === "loaded" && s.state.error && (g = null), s)
        ),
      }),
      g.promise
    );
  ...
  function Pe(e) {
    ...
    s && s.remove(),
      ...
      (V = new t.root({
        target: r,
        props: { ...e.props, stores: B, components: l },
        hydrate: !0,
      })),
      Ae(x);
    const n = {
      ...
      to: {
        params: d.params,
        route: { id: ((o = d.route) == null ? void 0 : o.id) ?? null },
  ...
  async function X({
    ...
    let _ = "never";
    for (const y of n)
      (y == null ? void 0 : y.slash) !== void 0 && (_ = y.slash);
    (e.pathname = Qe(e.pathname, _)), (e.search = e.search);
    const b = {
      type: "loaded",
      state: { url: e, params: s, branch: n, error: a, route: c },
      props: { constructors: kt(n).map((y) => y.node.component) },
    };
    ...
    return (
      (!d.url ||
        ...
        (b.props.page = {
          error: a,
          params: s,
          route: { id: (c == null ? void 0 : c.id) ?? null },
          status: o,
          url: new URL(e),
          form: p ?? null,
          data: L ? v : H.data,
  ...
  async function ue({
    ...
    if ((v = b.universal) != null && v.load) {
      let P = function (...w) {
        for (const O of w) {
          const { href: j } = new URL(O, n);
          _.dependencies.add(j);
        }
      };
      const y = {
        route: new Proxy(a, { get: (w, O) => ((_.route = !0), w[O]) }),
        params: new Proxy(o, { get: (w, O) => (_.params.add(O), w[O]) }),
        ...
        async fetch(w, O) {
          ...
          return (
            P(F.href),
            F.origin === n.origin && (j = F.href.slice(n.origin.length)),
            T ? ft(j, F.href, O) : lt(j, O)
          );
        },
        setHeaders: () => {},
        depends: P,
      ...
      (p = (await b.universal.load.call(null, y)) ?? null),
        (p = p ? await At(p, a.id) : null);
    }
    return {
      node: b,
      loader: e,
      ...
      universal:
        (L = b.universal) != null && L.load
          ? { type: "data", data: p, uses: _ }
          : null,
      data: p ?? (c == null ? void 0 : c.data) ?? null,
      slash:
        n.pathname === q || n.pathname === q + "/"
          ? "always"
          : ((A = b.universal) == null ? void 0 : A.trailingSlash) ??
            (c == null ? void 0 : c.slash),
    };
  }
  function Oe(e, s, n, o, a) {
    ...
    for (const c of o.params) if (a[c] !== d.params[c]) return !0;
  ...
  async function he({ id: e, invalidating: s, url: n, params: o, route: a }) {
    if ((g == null ? void 0 : g.id) === e) return g.promise;
    const { errors: c, layouts: p, leaf: _ } = a,
      b = [...p, _];
    c.forEach((S) => (S == null ? void 0 : S().catch(() => {}))),
      b.forEach((S) => (S == null ? void 0 : S[1]().catch(() => {})));
    let v = null;
    ...
    const y = b.map((S, I) => {
      ...
      const k = d.branch[I],
        $ =
          !!(S != null && S[0]) &&
          ((k == null ? void 0 : k.loader) !== S[1] ||
            Oe(P, A, L, (G = k.server) == null ? void 0 : G.uses, o));
      return $ && (P = !0), $;
    });
    if (y.some(Boolean)) {
      try {
        ...
        return ie({
          ...
          error: await Q(S, { url: n, params: o, route: { id: a.id } }),
          url: n,
          route: a,
        });
      }
    ...
    const j = b.map(async (S, I) => {
      ...
      if (
        (!$ || $.type === "skip") &&
        S[1] === (k == null ? void 0 : k.loader) &&
        !Oe(O, A, L, (pe = k.universal) == null ? void 0 : pe.uses, o)
      )
        return k;
      ...
      return ue({
        ...
        parent: async () => {
          var Te;
          const $e = {};
          for (let ge = 0; ge < I; ge += 1)
            Object.assign($e, (Te = await j[ge]) == null ? void 0 : Te.data);
          return $e;
        },
        server_data_node: de(
          $ === void 0 && S[0] ? { type: "skip" } : $ ?? null,
          S[0] ? (k == null ? void 0 : k.server) : void 0
        ),
      });
    });
      ...
      if (b[S])
        try {
          ...
          if (w != null && w.includes(I)) (k = I.status ?? k), ($ = I.error);
            ...
            $ = await Q(I, { params: o, url: n, route: { id: a.id } });
          }
  ...
  async function ie({ status: e, error: s, url: n, route: o }) {
    const a = {};
    let c = null;
    if (t.server_loads[0] === 0)
      try {
        ...
        (n.origin !== Fe || n.pathname !== location.pathname || N) &&
          (await K(n));
      }
    const _ = await ue({
        loader: i,
  ...
  function Ue({ url: e, type: s, intent: n, delta: o }) {
    let a = !1;
    const c = Be(d, n, e, s);
  ...
  async function ce({
    ...
    var j, F, S;
    const L = Z(e, !1),
      A = Ue({ url: e, type: c, delta: p, intent: L });
    if (!A) {
      v();
      return;
    }
    ...
    if (((e = (L == null ? void 0 : L.url) || e), W !== _))
      return A.reject(new Error("navigation was aborted")), !1;
    if (y.type === "redirect")
      if (o >= 20)
        y = await ie({
          status: 500,
      ...
      ((j = y.props.page) == null ? void 0 : j.status) >= 400 &&
        (await B.updated.check()) &&
        (await K(e));
    if (
      ((E.length = 0),
      (z = !1),
      ...
      (F = y.props.page) != null &&
        F.url &&
        y.props.page.url.pathname !== e.pathname &&
        (e.pathname = (S = y.props.page) == null ? void 0 : S.url.pathname),
      a)
    ) {
    ...
    if (((g = null), T)) {
      ...
      const I = (
        await Promise.all(m.on_navigate.map((k) => k(A.navigation)))
    ...
    !n && !O && Ee(),
      (R = !0),
      y.props.page && (H = y.props.page),
      (U = !1),
      c === "popstate" && Ae(x),
      A.fulfil(void 0),
      m.after_navigate.forEach((I) => I(A.navigation)),
      B.navigating.set(null),
      (D = !1);
  }
  async function Ne(e, s, n, o) {
    return e.origin === Fe && e.pathname === location.pathname && !N
      ? await ie({ status: o, error: n, url: e, route: s })
      : await K(e);
  }
  function Xe() {
    let e;
    ...
    u.addEventListener("mousedown", s),
      u.addEventListener("touchstart", s, { passive: !0 });
    const n = new IntersectionObserver(
      (c) => {
        for (const p of c)
          p.isIntersecting &&
            (oe(se(new URL(p.target.href))), n.unobserve(p.target));
      },
      { threshold: 0 }
    );
    function o(c, p) {
      const _ = De(c, u);
      if (!_) return;
      const { url: b, external: v, download: L } = ye(_, q);
      if (v || L) return;
      const A = le(_);
      if (!A.reload)
        if (p <= A.preload_data) {
    ...
    function a() {
      ...
      for (const c of u.querySelectorAll("a")) {
        const { url: p, external: _, download: b } = ye(c, q);
        if (_ || b) continue;
        const v = le(c);
        v.reload ||
          (v.preload_code === Me.viewport && n.observe(c),
          v.preload_code === Me.eager && oe(se(p)));
      }
    }
  ...
  function Q(e, s) {
    return e instanceof ne
      ? e.body
      : t.hooks.handleError({ error: e, event: s }) ?? {
          message:
            s.route.id === null && e instanceof It
              ? "Not Found"
              : "Internal Error",
        };
  }
  return {
    ...
    invalidate: (e) => {
      if (typeof e == "function") E.push(e);
        ...
        const { href: s } = new URL(e, location.href);
        E.push((n) => n.href === s);
      }
      return ke();
    },
    ...
    preload_data: async (e) => {
      ...
      if (!n)
        throw new Error(
          `Attempted to preload a URL that does not belong to this app: ${s}`
        );
      await Le(n);
    },
    preload_code: oe,
    ...
    _start_router: () => {
      ...
      (history.scrollRestoration = "manual"),
        ...
        ((s = navigator.connection) != null && s.saveData) || Xe(),
        u.addEventListener("click", (n) => {
          ...
          if (!o) return;
          const { url: a, external: c, target: p, download: _ } = ye(o, q);
          if (!a) return;
          if (p === "_parent" || p === "_top") {
          ...
          if (
            ...
            return;
          if (c || b.reload) {
            Ue({ url: a, type: "link" }) ? (U = !0) : n.preventDefault();
            return;
          }
          ...
          if (A !== void 0 && L === location.href.split("#")[0]) {
            if (d.url.hash === a.hash) {
              n.preventDefault(),
                (P = o.ownerDocument.getElementById(A)) == null ||
                  P.scrollIntoView();
              return;
            }
        ...
        u.addEventListener("submit", (n) => {
          ...
          if (_e(p, q)) return;
          const _ = n.target,
            { keep_focus: b, noscroll: v, reload: L, replace_state: A } = le(_);
          if (L) return;
          n.preventDefault(), n.stopPropagation();
          const P = new FormData(_),
            y = a == null ? void 0 : a.getAttribute("name");
          y &&
            P.append(y, (a == null ? void 0 : a.getAttribute("value")) ?? ""),
            (p.search = new URLSearchParams(P).toString()),
            ce({
              url: p,
              scroll: v ? te() : null,
              keepfocus: b ?? !1,
        ...
        addEventListener("popstate", async (n) => {
          ...
          if (((W = {}), (o = n.state) != null && o[M])) {
            ...
            if (
              ((a = d.url) == null ? void 0 : a.href.split("#")[0]) ===
      ...
      function e(n) {
        (d.url = n), B.page.set({ ...H, url: n }), B.page.notify();
      }
    },
    _hydrate: async ({
      status: e = 200,
      ...
      ({ params: o = {}, route: a = { id: null } } = Z(_, !1) || {});
      let b;
      try {
        const v = n.map(async (P, y) => {
            const w = c[y];
            return (
              w != null && w.uses && (w.uses = Ye(w.uses)),
              ue({
                loader: t.nodes[P],
                url: _,
                params: o,
                ...
                parent: async () => {
                  const O = {};
                  for (let j = 0; j < y; j += 1)
                    Object.assign(O, (await v[j]).data);
                  return O;
                },
        ...
        b = await ie({
          ...
          error: await Q(v, { url: _, params: o, route: a }),
          url: _,
          route: a,
        });
      }
...
async function He(t, r) {
  var h;
  const f = new URL(t);
  (f.pathname = it(t.pathname)),
    t.pathname.endsWith("/") && f.searchParams.append(Pt, "1"),
    f.searchParams.append(Lt, r.map((u) => (u ? "1" : "0")).join(""));
  const i = await Ke(f.href);
  if (
    ((h = i.headers.get("content-type")) != null &&
      h.includes("text/html") &&
      (await K(t)),
    !i.ok)
  )
    throw new ne(i.status, await i.json());
  return new Promise(async (u) => {
    ...
    function m(T) {
      return St(T, {
        Promise: (R) =>
          new Promise((D, U) => {
            E.set(R, { fulfil: D, reject: U });
          }),
      });
    }
    let d = "";
    for (;;) {
      const { done: T, value: R } = await l.read();
      if (T && !d) break;
      for (
        d +=
          !R && d
          ...
          (N = U.nodes) == null ||
            N.forEach((C) => {
              (C == null ? void 0 : C.type) === "data" &&
                ((C.uses = Ye(C.uses)), (C.data = m(C.data)));
            }),
            u(U);
        else if (U.type === "chunk") {
          const { id: C, data: z, error: V } = U,
            x = E.get(C);
        ...
        if (i.rangeCount === h.length) {
          for (let u = 0; u < i.rangeCount; u += 1) {
            const E = h[u],
              l = i.getRangeAt(u);
            if (
              E.commonAncestorContainer !== l.commonAncestorContainer ||
              E.startContainer !== l.startContainer ||
              E.endContainer !== l.endContainer ||
              E.startOffset !== l.startOffset ||
              E.endOffset !== l.endOffset
            )
              return;
          }
          i.removeAllRanges();
  ...
  return (
    E.catch(() => {}),
    {
      navigation: {
        from: {
          params: t.params,
          route: { id: ((g = t.route) == null ? void 0 : g.id) ?? null },
          url: t.url,
        },
        to: f && {
          ...
          route: {
            id:
              ((m = r == null ? void 0 : r.route) == null ? void 0 : m.id) ??
              null,
          },
          url: f,
        },
...
async function Nt(t, r, f) {
  const i = Ot(t, r);
  Ze({ client: i }),
    f ? await i._hydrate(f) : i.goto(location.href, { replaceState: !0 }),
    i._start_router();
}
export { Nt as start };
