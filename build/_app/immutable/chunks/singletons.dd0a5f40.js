import { F as d, s as E } from "./index.116c98fe.js";
const u = [];
function p(e, t = d) {
  let n;
  const o = new Set();
...
var g;
const w = ((g = globalThis.__sveltekit_34zibc) == null ? void 0 : g.base) ?? "";
var k;
const A =
    ((k = globalThis.__sveltekit_34zibc) == null ? void 0 : k.assets) ?? w,
  R = "1723603613748",
...
const Y = { url: h({}), page: h({}), navigating: p(null), updated: S() };
export {
  O as I,
  _ as P,
  x as S,
