    ...
    const u = e[o].claim_order,
      f =
        (s > 0 && e[n[s]].claim_order <= u
          ? s + 1
          : Et(1, s, (_) => e[n[_]].claim_order, u)) - 1;
    i[o] = n[f] + 1;
    const a = f + 1;
...
`;
  ...
  const f =
    ...
    _ = ot(t),
    { stylesheet: h, rules: d } = L.get(_) || qt(_, t);
  d[a] ||
...
function I(t, e) {
  const n = (t.style.animation || "").split(", "),
    ...
    s = n.length - i.length;
  s && ((t.style.animation = i.join(", ")), (z -= s), z || Lt());
}
function Lt() {
  K(() => {
    z ||
...
function mt() {
  ...
  do {
    ...
    for (D(null), N.length = 0, k = 0; X.length; ) X.pop()();
...
function xe(t, e, n) {
  ...
  function f() {
    ...
    l && l.abort(),
      ...
      (l = rt((E) => {
        if (c) {
          if (E >= j) return g(1, 0), B(t, !0, "end"), u(), (c = !1);
          if (E >= y) {
            const C = d((E - y) / h);
            g(C, 1 - C);
          }
  ...
  return {
    start() {
      a || ((a = !0), I(t), F(s) ? ((s = s(i)), pt().then(f)) : f());
    },
    invalidate() {
      a = !1;
    },
...
function $e(t, e, n) {
  ...
  function o() {
    ...
    T(() => B(t, !1, "start")),
      rt((p) => {
        if (c) {
          if (p >= g) return _(0, 1), B(t, !1, "end"), --l.r || v(l.c), !1;
          if (p >= d) {
            const y = a((p - d) / f);
            _(1 - y, y);
          }
...
function Ee(t, e, n, i, s, c, r, l, o, u, f, a) {
  let _ = t.length,
    h = c.length,
    d = _;
  const g = {};
  ...
  for (d = h; d--; ) {
    const m = a(s, c, d),
      w = n(m);
    let x = r.get(w);
    x ? i && E.push(() => x.p(m, e)) : ((x = u(w, m)), x.c()),
      y.set(w, (p[d] = x)),
...
function Ht(t, e, n, i) {
  ...
  s && s.m(e, n),
    i ||
      T(() => {
        const r = t.$$.on_mount.map(tt).filter(F);
    ...
    ((u.ctx = n
      ? n(t, e.props || {}, (a, _, ...h) => {
          ...
          return (
            u.ctx &&
              s(u.ctx[a], (u.ctx[a] = d)) &&
              (!u.skip_bound && u.bound[a] && u.bound[a](d), f && Gt(t, a)),
            _
          );
        })
      : []),
