<script lang="ts">
  ...
  onMount(async () => {
    const resp = await fetch(
      "https://api.github.com/users/navyagpt/repos?per_page=100"
    );
...
<section class="layout-md py-12">
  ...
  <p class="text-lg">
    ...
    <a class="link" href="mailto:navya.kgupta2@gmail.com?subject=Software%20Projects"
      >let me know</a
    >!
  </p>
</section>
...
<div class="bg-neutral-50 border-b border-neutral-200 py-4">
  <div class="flex justify-center space-x-6">
    ...
    >
      <Star size={18} strokeWidth={1.8} class="mr-1.5" /> Alphabetical
    </button>
  </div>
</div>
